...
- 主入口：app/cli/main.py 中的 start_cli
...
4. 然后读 app/cli/main.py、app/cli/commands.py、core/llm/manager.py、core/llm/logging.py、core/llm/runtime.py、core/llm/factory.py，理解入口、命令分发、日志和 provider 封装。
